...
import Me, { forwardRef as bn, createElement as Mr, useState as X, useRef as Ur, useEffect as pe } from "react";
...
function On() {
  ...
  return s.NODE_ENV !== "production" && function() {
    ...
    var E = !1, I = !1, D = !1, z = !1, ne = !1, B;
    B = Symbol.for("react.module.reference");
    function he(d) {
      return !!(typeof d == "string" || typeof d == "function" || d === n || d === a || ne || d === i || d === l || d === h || z || d === w || E || I || D || typeof d == "object" && d !== null && (d.$$typeof === p || d.$$typeof === f || d.$$typeof === o || d.$$typeof === c || d.$$typeof === u || // This needs to include all possible module reference object
    ...
    var te = Object.assign, ge = 0, _e, we, yt, _t, G, qe, We;
    function wt() {
    }
    ...
    function be() {
      {
        if (ge === 0) {
          _e = console.log, we = console.info, yt = console.warn, _t = console.error, G = console.group, qe = console.groupCollapsed, We = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: wt,
...
` + R[W].replace(" at new ", " at ");
    ...
    var tt = Object.prototype.hasOwnProperty, xr = {}, Or = j.ReactDebugCurrentFrame;
    function bt(d) {
      if (d) {
    ...
    function jr(d) {
      if (tn(d))
        return P("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", en(d)), Tr(d);
    }
    var rt = j.ReactCurrentOwner, rn = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function an(d, g) {
      if (typeof d.ref == "string" && rt.current && g && rt.current.stateNode !== g) {
        ...
        Ht[_] || (P('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Y(rt.current.type), d.ref), Ht[_] = !0);
      }
    }
    function on(d, g) {
      {
    ...
    function un(d, g, _, k, L) {
      {
        var M, $ = {}, R = null, K = null;
        _ !== void 0 && (jr(_), R = "" + _), nn(g) && (jr(g.key), R = "" + g.key), sn(g) && (K = g.ref, an(g, L));
        for (M in g)
          tt.call(g, M) && !rn.hasOwnProperty(M) && ($[M] = g[M]);
        if (d && d.defaultProps) {
        ...
        return ln(d, R, K, L, k, rt.current, $);
      }
    }
    ...
    function Dr(d, g) {
      {
        ...
        $r[_] = !0;
        var k = "";
        d && d._owner && d._owner !== Vt.current && (k = " It was passed a child from " + Y(d._owner.type) + "."), He(d), P('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', _, k), He(null);
      }
    }
    function Ir(d, g) {
      {
    ...
    function gn(d) {
      {
        for (var g = Object.keys(d.props), _ = 0; _ < g.length; _++) {
          var k = g[_];
          if (k !== "children" && k !== "key") {
            He(d), P("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", k), He(null);
            break;
          }
        }
    ...
    function Nr(d, g, _, k, L, M) {
      {
        ...
        if (tt.call(g, "key")) {
          var Ae = Y(d), Q = Object.keys(g).filter(function(wn) {
            return wn !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Gt, Ae, _n, Ae), Lr[Ae + Gt] = !0;
          }
        }
        return d === n ? gn(H) : fn(H), H;
      }
    }
    function pn(d, g, _) {
      return Nr(d, g, _, !0);
    ...
    var vn = mn, yn = pn;
    nt.Fragment = n, nt.jsx = vn, nt.jsxs = yn;
  }(), nt;
}
var Tn = {};
Tn.NODE_ENV === "production" ? ar.exports = xn() : ar.exports = On();
var y = ar.exports, or, jn = {}, St = Sn;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Rn = (s) => s.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase().trim(), me = (s, e) => {
  const t = bn(
    ({
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const In = me("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
class zn {
  constructor(e, { headers: t = {}, customFetch: r, region: n = cr.Any } = {}) {
    this.url = e, this.headers = t, this.region = n, this.fetch = qn(r);
  }
  /**
...
var ee = {}, br = {}, At = {}, pt = {}, $t = {}, Dt = {}, Yn = function() {
  if (typeof self < "u")
    return self;
  if (typeof window < "u")
    return window;
...
const Gn = Qe.fetch, bs = Qe.fetch.bind(Qe), Ss = Qe.Headers, Kn = Qe.Request, Jn = Qe.Response, Xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Headers: Ss,
  Request: Kn,
  Response: Jn,
  default: bs,
  fetch: Gn
}, Symbol.toStringTag, { value: "Module" })), Qn = /* @__PURE__ */ kn(Xe);
var It = {};
...
const Zn = Es(Qn), ei = Es(It);
let ti = class {
  constructor(e) {
    this.shouldThrowOnError = !1, this.method = e.method, this.url = e.url, this.headers = e.headers, this.schema = e.schema, this.body = e.body, this.shouldThrowOnError = e.shouldThrowOnError, this.signal = e.signal, this.isMaybeSingle = e.isMaybeSingle, e.fetch ? this.fetch = e.fetch : typeof fetch > "u" ? this.fetch = Zn.default : this.fetch = fetch;
  }
  /**
...
Dt.default = ti;
var ri = oe && oe.__importDefault || function(s) {
  return s && s.__esModule ? s : { default: s };
};
...
$t.default = ni;
var ii = oe && oe.__importDefault || function(s) {
  return s && s.__esModule ? s : { default: s };
};
Object.defineProperty(pt, "__esModule", { value: !0 });
const ai = ii($t);
let oi = class extends ai.default {
  /**
...
pt.default = oi;
var ci = oe && oe.__importDefault || function(s) {
  return s && s.__esModule ? s : { default: s };
};
...
const ui = Nt;
Lt.DEFAULT_HEADERS = { "X-Client-Info": `postgrest-js/${ui.version}` };
var ks = oe && oe.__importDefault || function(s) {
  return s && s.__esModule ? s : { default: s };
};
Object.defineProperty(br, "__esModule", { value: !0 });
const di = ks(At), hi = ks(pt), fi = Lt;
let gi = class xs {
   ...
   */
  constructor(e, { headers: t = {}, schema: r, fetch: n } = {}) {
    this.url = e, this.headers = Object.assign(Object.assign({}, fi.DEFAULT_HEADERS), t), this.schemaName = r, this.fetch = n;
  }
  /**
  ...
  rpc(e, t = {}, { head: r = !1, get: n = !1, count: i } = {}) {
    ...
    return i && (u.Prefer = `count=${i}`), new hi.default({
      method: a,
      url: o,
      headers: u,
      schema: this.schemaName,
...
const {
  ...
  PostgrestBuilder: cl
} = pi, vi = "2.10.7", yi = { "X-Client-Info": `realtime-js/${vi}` }, _i = "1.0.0", As = 1e4, wi = 1e3;
var Je;
(function(s) {
...
const Br = (s, e, t = {}) => {
  ...
  return Object.keys(e).reduce((i, a) => (i[a] = Si(a, s, e, n), i), {});
}, Si = (s, e, t, r) => {
  ...
  return s;
}, Ti = (s) => typeof s == "string" ? s.replace(" ", "T") : s, Is = (s) => {
  let e = s;
...
class Ci {
  ...
  constructor(e, t) {
    var r;
    this.accessToken = null, this.apiKey = null, this.channels = [], this.endPoint = "", this.httpEndpoint = "", this.headers = yi, this.params = {}, this.timeout = As, this.heartbeatIntervalMs = 3e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = ji, this.conn = null, this.sendBuffer = [], this.serializer = new bi(), this.stateChangeCallbacks = {
      open: [],
      close: [],
      error: [],
      message: []
  ...
  connect() {
    if (!this.conn) {
      ...
      this.conn = new Ai(this._endPointURL(), void 0, {
        close: () => {
          this.conn = null;
        }
      }), import("./browser-CpOR4bJj.js").then((e) => e.b).then(({ default: e }) => {
   ...
   */
  _endPointURL() {
    return this._appendParams(this.endPoint, Object.assign({}, this.params, { vsn: _i }));
  }
  /** @internal */
  _onConnMessage(e) {
  ...
  _sendHeartbeat() {
    ...
    if (this.isConnected()) {
      if (this.pendingHeartbeatRef) {
        this.pendingHeartbeatRef = null, this.log("transport", "heartbeat timeout. Attempting to re-establish connection"), (e = this.conn) === null || e === void 0 || e.close(wi, "hearbeat timeout");
        return;
      }
  ...
  _workerObjectUrl(e) {
    ...
    if (e)
      ...
      const r = new Blob([Ri], { type: "application/javascript" });
...
const Ls = (s) => {
  let e;
  return s ? e = s : typeof fetch > "u" ? e = (...t) => Promise.resolve().then(() => Xe).then(({ default: r }) => r(...t)) : e = fetch, (...t) => e(...t);
}, Ii = () => Di(void 0, void 0, void 0, function* () {
...
const Jt = (s) => s.msg || s.message || s.error_description || s.error || JSON.stringify(s), Li = (s, e, t) => Ue(void 0, void 0, void 0, function* () {
  const r = yield Ii();
  s instanceof r && !(t != null && t.noResolveJson) ? s.json().then((n) => {
    e(new $i(Jt(n), s.status || 500));
  }).catch((n) => {
    e(new dr(Jt(n), n));
  }) : e(new dr(Jt(s), s));
}), Ni = (s, e, t, r) => {
...
function mt(s, e, t, r, n, i) {
  return Ue(this, void 0, void 0, function* () {
    return new Promise((a, o) => {
      s(t, Ni(e, r, n, i)).then((c) => {
        if (!c.ok)
          throw c;
        return r != null && r.noResolveJson ? c : c.json();
      }).then((c) => a(c)).catch((c) => Li(c, o, r));
    });
  });
}
function Rt(s, e, t, r) {
...
class qi {
  ...
  exists(e) {
    return Z(this, void 0, void 0, function* () {
      const t = this._getFinalPath(e);
      try {
        return yield Ui(this.fetch, `${this.url}/object/${t}`, {
          headers: this.headers
        }), { data: !0, error: null };
      } catch (r) {
  ...
  list(e, t, r) {
    return Z(this, void 0, void 0, function* () {
      try {
        const n = Object.assign(Object.assign(Object.assign({}, Fi), t), { prefix: e || "" });
...
const Yi = { "X-Client-Info": `supabase-js-${lt}/${zi}` }, Gi = {
  headers: Yi
}, Ki = {
  schema: "public"
}, Ji = {
...
}, ea = () => typeof Headers > "u" ? Ss : Headers, ta = (s, e, t) => {
  const r = Zi(t), n = ea();
...
function na(s, e) {
  const { db: t, auth: r, realtime: n, global: i } = s, { db: a, auth: o, realtime: c, global: u } = e, l = {
    ...
    accessToken: () => ra(this, void 0, void 0, function* () {
      return "";
    })
  };
  return s.accessToken ? l.accessToken = s.accessToken : delete l.accessToken, l;
}
const Ms = "2.65.1", ia = "http://localhost:9999", aa = "supabase.auth.token", oa = { "X-Client-Info": `gotrue-js/${Ms}` }, Kr = 10, fr = "X-Supabase-Api-Version", Us = {
  "2024-01-01": {
...
async function Zr(s) {
  ...
  if (n && n.getTime() >= Us["2024-01-01"].timestamp && typeof t == "object" && t && typeof t.code == "string" ? r = t.code : typeof t == "object" && t && typeof t.error_code == "string" && (r = t.error_code), r) {
    if (r === "weak_password")
      throw new Xr(De(t), s.status, ((e = t.weak_password) === null || e === void 0 ? void 0 : e.reasons) || []);
    ...
    throw new Xr(De(t), s.status, t.weak_password.reasons);
...
function ke(s) {
  var e;
  let t = null;
  Ca(s) && (t = Object.assign({}, s), s.expires_at || (t.expires_at = ca(s.expires_in)));
...
class ft {
  ...
  constructor(e) {
    var t, r;
    this.memoryStorage = null, this.stateChangeEmitters = /* @__PURE__ */ new Map(), this.autoRefreshTicker = null, this.visibilityChangedCallback = null, this.refreshingDeferred = null, this.initializePromise = null, this.detectSessionInUrl = !0, this.hasCustomAuthorizationHeader = !1, this.suppressGetSessionWarning = !1, this.lockAcquired = !1, this.pendingInLock = [], this.broadcastChannel = null, this.logger = console.log, this.instanceID = ft.nextInstanceID, ft.nextInstanceID += 1, this.instanceID > 0 && le() && console.warn("Multiple GoTrueClient instances detected in the same browser context. It is not an error, but this should be avoided as it may produce undefined behavior when used concurrently under the same storage key.");
    ...
    }, this.persistSession ? n.storage ? this.storage = n.storage : dt() ? this.storage = Da : (this.memoryStorage = {}, this.storage = ts(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = ts(this.memoryStorage)), le() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      try {
  ...
  async _getUser(e) {
    try {
      ...
      if (T(t))
        return Ea(t) && (await this._removeSession(), await kt(this.storage, `${this.storageKey}-code-verifier`)), { data: { user: null }, error: t };
      throw t;
    }
  }
  /**
...
class Wa {
  ...
  constructor(e, t, r) {
    ...
    })) : this.auth = this._initSupabaseAuthClient((a = l.auth) !== null && a !== void 0 ? a : {}, this.headers, l.global.fetch), this.fetch = ta(t, this._getAccessToken.bind(this), l.global.fetch), this.realtime = this._initRealtimeClient(Object.assign({ headers: this.headers }, l.realtime)), this.rest = new mi(`${o}/rest/v1`, {
      headers: this.headers,
      schema: l.db.schema,
      fetch: this.fetch
   ...
   */
  get storage() {
    return new Vi(this.storageUrl, this.headers, this.fetch);
  }
  /**
   * Perform a query on a table or a view.
   *
...
async function Ha() {
  try {
    ...
    throw console.error("Error initializing Supabase client:", s), new Error("Failed to initialize Supabase client");
  }
}
const Va = async () => (ht || (ht = await Ha()), ht), q = new Proxy({}, {
  get: (s, e) => {
    if (!ht)
...
function zs(s, e) {
  var l, h, f, p;
  const t = de(s), r = t.getFullYear(), n = Ut(), i = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((h = (l = e == null ? void 0 : e.locale) == null ? void 0 : l.options) == null ? void 0 : h.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((p = (f = n.locale) == null ? void 0 : f.options) == null ? void 0 : p.firstWeekContainsDate) ?? 1, a = Ne(s, 0);
...
function Io(s, e) {
  var o, c, u, l;
  const t = Ut(), r = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((l = (u = t.locale) == null ? void 0 : u.options) == null ? void 0 : l.firstWeekContainsDate) ?? 1, n = zs(s, e), i = Ne(s, 0);
  return i.setFullYear(n, 0, r), i.setHours(0, 0, 0, 0), gt(i, e);
}
function Lo(s, e) {
  const t = de(s), r = +gt(t, e) - +Io(t, e);
...
const zo = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Yo = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, Go = /^'([^]*?)'?$/, Ko = /''/g, Jo = /[a-zA-Z]/;
function Tt(s, e, t) {
  var l, h, f, p;
...
const Xo = { BASE_URL: "./", DEV: !1, MODE: "production", PROD: !0, SSR: !1, VITE_OPENAI_API_KEY: "", VITE_SUPABASE_ANON_KEY: "", VITE_SUPABASE_URL: "" }, us = (s) => {
  let e;
...
function tc() {
  ...
  return s.NODE_ENV !== "production" && function() {
    ...
    function n(x, E, I) {
      {
        var D = t.ReactDebugCurrentFrame, z = D.getStackAddendum();
        z !== "" && (E += "%s", I = I.concat([z]));
        var ne = I.map(function(B) {
          return String(B);
        });
        ne.unshift("Warning: " + E), Function.prototype.apply.call(console[x], console, ne);
      }
    }
    function i(x, E) {
    ...
    function p(x, E, I) {
      ...
      if (!f) {
        var z = E();
        a(D, z) || (r("The result of getSnapshot should be cached to avoid an infinite loop"), f = !0);
      }
      var ne = o({
        inst: {
          value: D,
      ...
      return u(function() {
        B.value = D, B.getSnapshot = E, w(B) && he({
          inst: B
        });
      }, [x, D, E]), c(function() {
        w(B) && he({
  ...
  return tr.useSyncExternalStoreWithSelector = function(u, l, h, f, p) {
    ...
    w = o(function() {
      function C(I) {
        ...
        var z = f(I);
        return p !== void 0 && p(D, z) ? D : (P = I, x = z);
      }
      ...
      var j = c(function() {
        var I = !1, D, z, ne = function(fe) {
          ...
          if (n(ge, fe))
            return _e;
          var we = w(fe);
          return v !== void 0 && v(_e, we) ? _e : (D = fe, z = we, we);
...
var ic = pr.exports;
const ac = /* @__PURE__ */ En(ic), Ks = { BASE_URL: "./", DEV: !1, MODE: "production", PROD: !0, SSR: !1, VITE_OPENAI_API_KEY: "", VITE_SUPABASE_ANON_KEY: "", VITE_SUPABASE_URL: "" }, { useDebugValue: oc } = Me, { useSyncExternalStoreWithSelector: cc } = ac;
let ms = !1;
const lc = (s) => s;
...
function je(s, e) {
  ...
  return function() {
    ...
    function n(i, a) {
      ...
      let u = s;
      return s[0] && (u = o.as || s, delete o.as), vr && u[0] && vr(o), Qs(u, o);
    }
    return n;
  };
}
...
})(), Sc = 20, Pt = /* @__PURE__ */ new Map(), Ec = 1e3, _s = (s) => {
  if (Pt.has(s)) return;
  let e = setTimeout(() => {
...
`, Fc = ({ toast: s }) => {
  ...
  return e !== void 0 ? typeof e == "string" ? se.createElement(Uc, null, e) : e : t === "blank" ? null : se.createElement(Nc, null, se.createElement(Ac, { ...r }), t !== "loading" && se.createElement(Lc, null, t === "error" ? se.createElement(Rc, { ...r }) : se.createElement(Ic, { ...r })));
}, qc = (s) => `
...
`, Bc = "0%{opacity:0;} 100%{opacity:1;}", Hc = "0%{opacity:1;} 100%{opacity:0;}", Vc = je("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
se.memo(({ toast: s, position: e, style: t, children: r }) => {
  let n = s.height ? Yc(s.position || e || "top-center", s.visible) : { opacity: 0 }, i = se.createElement(Fc, { toast: s }), a = se.createElement(zc, { ...s.ariaProps }, yr(s.message, s));
...
})), ws = "chatbot_session_id", Jc = 180;
function Qc({ domainId: s }) {
  const [e, t] = X(!1), [r, n] = X(""), [i, a] = X([]), [o, c] = X([]), [u, l] = X("history"), [h, f] = X(null), [p, w] = X(!1), [v] = X(/* @__PURE__ */ new Set()), [S, C] = X(null), [j, P] = X(null), x = Ur(null), [E, I] = X(!1), D = Ur(null), { sendMessage: z } = Kc(), [ne, B] = X(!1), he = (m, b) => b.some(
    (O) => (
  ...
  pe(() => {
    ...
    (async () => {
      ...
      b || (b = window.crypto.randomUUID(), localStorage.setItem(ws, b)), P(b), await _e(b);
    })();
  }, []);
  const _e = async (m) => {
    try {
      ...
      if (J.setDate(J.getDate() - Jc), new Date(U.last_message_at) < J) {
      ...
      if (ce) {
        const Wt = ce.filter((Ce) => v.has(Ce.id) ? !1 : (v.add(Ce.id), !0));
        a(Wt);
      }
    } catch (b) {
    ...
    try {
      ...
      a((J) => he(U, J) ? J : [...J, U]), await z(m, O), n("");
    } catch (b) {
  ...
  return pe(() => {
    (async () => {
      try {
        ...
        console.error("Failed to initialize Supabase:", b);
      }
    })();
  }, []), /* @__PURE__ */ y.jsxs("div", { className: "fixed bottom-6 right-6 flex flex-col items-end z-[9999]", children: [
        ...
        u === "chat" && /* @__PURE__ */ y.jsxs("div", { className: "flex items-center gap-2", children: [
          ne ? /* @__PURE__ */ y.jsx(
            ...
            "button",
            {
              ...
              disabled: !h || E,
              children: /* @__PURE__ */ y.jsx(Fn, { className: "h-4 w-4" })
            }
          ),
          /* @__PURE__ */ y.jsx(
            "button",
        ...
        /* @__PURE__ */ y.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ y.jsx(
            "button",
            {
              ...
              style: We,
              children: p ? /* @__PURE__ */ y.jsx("div", { className: "h-5 w-5 border-2 border-white border-t-transparent rounded-full animate-spin" }) : /* @__PURE__ */ y.jsx(Nn, { className: "h-5 w-5" })
            }
          )
        ] }),
...
//# sourceMappingURL=main-B8U7RoNH.js.map
